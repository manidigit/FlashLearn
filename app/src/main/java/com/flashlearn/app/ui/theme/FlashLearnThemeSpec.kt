...
data class FlashLearnThemeSpec(
    ...
    val lightCard: Long = lightSurface,
    val darkCard: Long = darkSurface,
    val lightOutline: Long = 0xFFE1DDE7,
    ...
    companion object {
        ...
        val MODERN_PURPLE = FlashLearnThemeSpec(
            ...
            0xFF17141C, 0xFFF5F2F8, 0xFF68636F, 0xFFB7B2BE,
            0xFFFFFFFF, 0xFF171820, 0xFFE4DFEA, 0xFF36313E, 0xFF7C3AED, 0xFF536DFE,
            "outlined", 1f, 16f, 20f, 28f, 1f, 1f
        )
        val OCEAN_BLUE = MODERN_PURPLE.copy(
            id="ocean_blue", name="اقیانوس آبی", lightPrimary=0xFF1769E0, darkPrimary=0xFF69B7FF,
            lightSecondary=0xFF0891B2, darkSecondary=0xFF22D3EE, lightBackground=0xFFF4F9FF,
            darkBackground=0xFF07111D, lightSurfaceVariant=0xFFE8F2FF, darkSurfaceVariant=0xFF172A3D,
            gradientStart=0xFF1769E0, gradientEnd=0xFF08B6C9, lightOutline=0xFFD7E5F5, darkOutline=0xFF294257
        )
        val FRESH_GREEN = MODERN_PURPLE.copy(
            id="fresh_green", name="سبز تازه", lightPrimary=0xFF138A5B, darkPrimary=0xFF52D49A,
            lightSecondary=0xFF0D9488, darkSecondary=0xFF2DD4BF, lightBackground=0xFFF3FBF7,
            darkBackground=0xFF07130F, lightSurfaceVariant=0xFFE5F5EC, darkSurfaceVariant=0xFF172D25,
            gradientStart=0xFF138A5B, gradientEnd=0xFF0D9488
        )
        val SUNSET_ORANGE = MODERN_PURPLE.copy(
            id="sunset_orange", name="غروب گرم", lightPrimary=0xFFE4572E, darkPrimary=0xFFFF9A62,
            lightSecondary=0xFFF59E0B, darkSecondary=0xFFFBBF24, lightBackground=0xFFFFF8F4,
            darkBackground=0xFF160D08, lightSurfaceVariant=0xFFFFECE2, darkSurfaceVariant=0xFF332119,
            gradientStart=0xFFE4572E, gradientEnd=0xFFF59E0B
        )
        val MIDNIGHT = MODERN_PURPLE.copy(
            id="midnight", name="نیمه‌شب", lightPrimary=0xFF475569, darkPrimary=0xFFCBD5E1,
            lightSecondary=0xFF64748B, darkSecondary=0xFF94A3B8, lightBackground=0xFFF7F8FA,
            darkBackground=0xFF05070B, lightSurfaceVariant=0xFFE9EDF2, darkSurfaceVariant=0xFF151B24,
            gradientStart=0xFF334155, gradientEnd=0xFF0F172A
        )
        val LUXURY = MODERN_PURPLE.copy(
            id="luxury", name="لاکچری طلایی", lightPrimary=0xFF8A5A12, darkPrimary=0xFFE7B65B,
            lightSecondary=0xFFB8860B, darkSecondary=0xFFF3D38A, lightBackground=0xFFFBF8F1,
            darkBackground=0xFF0D0B08, lightSurface=0xFFFFFDF8, darkSurface=0xFF17130D,
        ...
        val ROSE_GOLD = MODERN_PURPLE.copy(
            id="rose_gold", name="رزگلد", lightPrimary=0xFFB45A6A, darkPrimary=0xFFFFA7B4,
        ...
        val FOREST = MODERN_PURPLE.copy(
            ...
            lightSecondary=0xFF4F772D, darkSecondary=0xFFA8D58A, lightBackground=0xFFF4F8F2,
            darkBackground=0xFF07100A, lightSurfaceVariant=0xFFE6EFE3, darkSurfaceVariant=0xFF17251A,
            gradientStart=0xFF276749, gradientEnd=0xFF4F772D, iconStyle="filled"
        )

        val BUILT_IN = listOf(MODERN_PURPLE, OCEAN_BLUE, FRESH_GREEN, SUNSET_ORANGE, MIDNIGHT, LUXURY, ROSE_GOLD, FOREST)

        fun fromJson(raw: String): FlashLearnThemeSpec {
            val j = JSONObject(raw)
            require(j.optInt("formatVersion") == FORMAT_VERSION)
