...
fun AddWordMethodScreen(
    ...
    Column(
        ...
        Box(Modifier.fillMaxWidth().height(58.dp)) {
            ...
            Text("افزودن واژه", modifier = Modifier.align(Alignment.Center), color = Navy,
                style = MaterialTheme.typography.headlineSmall.copy(fontWeight = FontWeight.Bold))
        }
        Spacer(Modifier.height(12.dp))
        Text("روش مورد نظر خود را انتخاب کنید", Modifier.fillMaxWidth(), color = Color(0xFF78839D),
        ...
        Spacer(Modifier.height(16.dp))
        MethodCard("ریستور بکاپ", "بازیابی واژه‌ها و اطلاعات از فایل پشتیبان", Green, SoftGreen, Icons.Outlined.Restore, onRestoreBackup)
...
private fun MethodCard(title: String, subtitle: String, color: Color, background: Color,
    ...
    Card(Modifier.fillMaxWidth().height(132.dp).clickable(onClick = onClick), shape = RoundedCornerShape(22.dp),
        ...
        Row(Modifier.fillMaxSize().padding(horizontal = 22.dp), verticalAlignment = Alignment.CenterVertically) {
            ...
            Column(horizontalAlignment = Alignment.End) {
                ...
                Text(subtitle, color = Color(0xFF78839D), style = MaterialTheme.typography.bodyLarge, textAlign = TextAlign.End)
            }
