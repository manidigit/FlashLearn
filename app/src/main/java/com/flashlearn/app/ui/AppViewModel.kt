...
class AppViewModel @Inject constructor(@ApplicationContext context:Context,private val settingsRepository:RoomSettingsRepository):ViewModel(){
 companion object{private const val PREFS="flashlearn_ui_settings";private const val KEY_APPEARANCE="appearance";private const val KEY_ACCENT="accent";private const val KEY_THEME="theme";private const val KEY_LAYOUT="layout";private const val KEY_SOURCE="language_source";private const val KEY_TARGET="language_target";private const val KEY_PERSONAL_DIFFICULTY="personal_difficulty";private const val KEY_QUIZ_DIFFICULTY="quiz_difficulty"}
 private val appContext=context.applicationContext;private val prefs=context.getSharedPreferences(PREFS,Context.MODE_PRIVATE);private val _state=mutableStateOf(loadPersistedState());val state:State<AppUiState> get()=_state
