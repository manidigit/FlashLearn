...
class MainActivity : ComponentActivity() {
    ...
    @Composable private fun TopLevelContent(route: String) {
        ...
        when (route) {
            ...
            AppRoutes.LIBRARY -> LibraryScreen(viewModel = libraryViewModel, languagePair = uiState.languagePair, onBack = { appViewModel.navigate(AppRoutes.HOME) }, onOpen = appViewModel::openLibraryDetail, onAddWord = { appViewModel.navigate(AppRoutes.ADD_WORD) }, onBulkImport = { appViewModel.navigate(AppRoutes.BULK_IMPORT) })
